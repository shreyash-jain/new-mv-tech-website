...
import sty from "./PlasmicButton.module.css"; // plasmic-import: MH55VD1W95Bb/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: fP8_U-UY081v/icon
      ...
      >
        ...
        {(hasVariant($state, "withIcons", "withSuffixIcon") ? true : false)
          ? renderPlasmicSlot({
              defaultContents: (
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__u7Yf)}
                  role={"img"}
                />
              ),
