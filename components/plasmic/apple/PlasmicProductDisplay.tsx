...
import sty from "./PlasmicProductDisplay.module.css"; // plasmic-import: atJVqiJUV44Q/css

import Icon6Icon from "./icons/PlasmicIcon__Icon6"; // plasmic-import: e2TLGAl2MDoJ/icon
...
function PlasmicProductDisplay__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__jhDiW)}>
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__fdzrl, {
            [sty.imgdark__fdzrlAv0Hh]: hasVariant($state, "dark", "dark"),
            [sty.imgisMobileView__fdzrlVcmJz]: hasVariant(
              $state,
              "isMobileView",
              "isMobileView"
            )
        ...
        <PlasmicImg__
          alt={""}
          className={classNames(sty.img__ktXBr, {
            [sty.imgisMobileView__ktXBrVcmJz]: hasVariant(
              $state,
              "isMobileView",
              "isMobileView"
            )
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__qE4Zj, {
          [sty.freeBoxreverse__qE4ZjyDyui]: hasVariant(
            $state,
            "reverse",
            "reverse"
          )
      ...
      >
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___397P9, {
            [sty.freeBoxdark___397P9Av0Hh]: hasVariant($state, "dark", "dark")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <Button
                  className={classNames("__wab_instance", sty.button__dimMq)}
                  iconLeft={
                    <Icon6Icon
                      className={classNames(projectcss.all, sty.svg__z0Xt8)}
                      role={"img"}
                    />
                  }
                  size={"large"}
                ...
                <Button
                  className={classNames("__wab_instance", sty.button__oeqx)}
                  iconLeft={
                    <Icon6Icon
                      className={classNames(projectcss.all, sty.svg__tPLxd)}
                      role={"img"}
                    />
                  }
                  size={"large"}
