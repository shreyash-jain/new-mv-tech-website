...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: dYzrPrrV1Cb-/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg___6Gzxr)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg___8FPkV)}
              role={"img"}
            />
          ),
