...
embedCssProps
      ...
      {...parallaxProviderWrapperProps}
      scrollAxis={(parallaxProviderWrapperProps && "scrollAxis" in parallaxProviderWrapperProps) ? parallaxProviderWrapperProps.scrollAxis! : "vertical"}
      >
...
wireframe={(antdConfigProviderProps && "wireframe" in antdConfigProviderProps) ? antdConfigProviderProps.wireframe! : false}
      ...
      {...cmsCredentialsProviderProps}
      databaseId={(cmsCredentialsProviderProps && "databaseId" in cmsCredentialsProviderProps) ? cmsCredentialsProviderProps.databaseId! : "mn6EnZwwEFGhFFawwZYobS"}
databaseToken={(cmsCredentialsProviderProps && "databaseToken" in cmsCredentialsProviderProps) ? cmsCredentialsProviderProps.databaseToken! : "5EkFsYr7vTg3R7bEjuQfEjdiKyKgu40AYsPbqDwc7QxW3k3aVK0BaUCr8nw5OnxXGSqjFCA67NSuUc5kIYpw"}
...
locale={(cmsCredentialsProviderProps && "locale" in cmsCredentialsProviderProps) ? cmsCredentialsProviderProps.locale! : undefined}
      >
        
      <EmbedCss
      {...embedCssProps}
      css={(embedCssProps && "css" in embedCssProps) ? embedCssProps.css! : "/* CSS snippet */\n\n.rotate {\n    animation-name: rotator;\n    animation-duration: 60s;\n    animation-iteration-count: infinite;\n    animation-timing-function: linear;\n}\n\n@keyframes rotator {\n    from {\n        transform: rotate(0);\n    }\n    to {\n        transform: rotate(359deg);\n    }\n}"}
      >
        { children }
      </EmbedCss>
