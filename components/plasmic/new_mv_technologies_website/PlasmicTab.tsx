...
import sty from "./PlasmicTab.module.css"; // plasmic-import: jf_z6wjG7bBo/css
          ...
          {false ? (
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <CheckSvgIcon
                    className={classNames(projectcss.all, sty.svg__fn6Rf)}
                    role={"img"}
                  />
                ),
          ...
          {false ? (
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <Icon38Icon
                    className={classNames(projectcss.all, sty.svg__qlVeW)}
                    role={"img"}
                  />
                ),
