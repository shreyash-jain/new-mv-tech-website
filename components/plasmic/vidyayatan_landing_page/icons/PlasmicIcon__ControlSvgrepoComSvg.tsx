...
export type ControlSvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function ControlSvgrepoComSvgIcon(props: ControlSvgrepoComSvgIconProps) {
...
export default ControlSvgrepoComSvgIcon;
/* prettier-ignore-end */
