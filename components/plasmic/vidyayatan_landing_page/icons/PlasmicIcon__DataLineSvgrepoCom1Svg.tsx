...
export type DataLineSvgrepoCom1SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function DataLineSvgrepoCom1SvgIcon(
  props: DataLineSvgrepoCom1SvgIconProps
) {
...
export default DataLineSvgrepoCom1SvgIcon;
/* prettier-ignore-end */
