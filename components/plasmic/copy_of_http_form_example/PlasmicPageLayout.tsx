...
// Plasmic Project: 3bymCcdN3cZySmRQHMsPRL
// Component: jTJ15YuBUEXK
...
import projectcss from "./plasmic.module.css"; // plasmic-import: 3bymCcdN3cZySmRQHMsPRL/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: jTJ15YuBUEXK/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: bMSLPxko6Q9m/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: 6X7E-lFc4msi/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__k2De)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__xvb3J)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__ybCV)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__miQuk)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__d2Rqq)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
