...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: lAwn5Lr-_-8n/css

import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: G24Ns8ZG2eYX/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__dhuQ8)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__uc3Ur)}
              role={"img"}
            />
          ),
