...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 5gbK3fM9Ivcn/css
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.column___0Lgrg)}>
        <h2
        ...
        >
          <div className={classNames(projectcss.all, sty.column__ems1L)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column__nFlGb)}>
            <h5
