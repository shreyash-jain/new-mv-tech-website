...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: 1uri1TGbiD_Q/component
import Select__Option from "../../Select__Option"; // plasmic-import: yuA-dLL5iZqv/component
import Select__OptionGroup from "../../Select__OptionGroup"; // plasmic-import: bVqGmVyQNWB2/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: ybfbkvuYhwx2f8pSa8cKG/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: kmb8PudXaPVm/css

import ChevronDownSvgIcon from "./icons/PlasmicIcon__ChevronDownSvg"; // plasmic-import: lONB2KwcxUwe/icon
import ChevronUpSvgIcon from "./icons/PlasmicIcon__ChevronUpSvg"; // plasmic-import: P6YLN5aAiD2i/icon
    ...
    if (!("children" in props)) {
      props = {
        ...
        children: (
          <React.Fragment>
            <Select__Option
              className={classNames("__wab_instance", sty.option__dk2Rk)}
              value={"value1"}
            >
              {"Option 1"}
            </Select__Option>
            <Select__Option
              className={classNames("__wab_instance", sty.option__iLjnp)}
              value={"value2"}
            >
              {"Option 2"}
            </Select__Option>
