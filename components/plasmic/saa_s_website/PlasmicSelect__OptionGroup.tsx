...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: bVqGmVyQNWB2/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: kmb8PudXaPVm/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__pEjNg)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__fwXys)}
              />
            </React.Fragment>
          ),
          value: args.children
