...
import sty from "./PlasmicButton.module.css"; // plasmic-import: nA9aFohkQkw9/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: zgy1ZdQGGESh/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: MN25ciEYlzB-/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__l5R4Y)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__cA3G9)}
                role={"img"}
              />
            ),
